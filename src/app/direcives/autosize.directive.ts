import {Input, AfterViewInit, ElementRef, HostListener, Directive, OnInit, AfterViewChecked} from '@angular/core';

@Directive({
  selector: 'textarea[autosize]'
})

export class Autosize implements AfterViewInit, AfterViewChecked {
